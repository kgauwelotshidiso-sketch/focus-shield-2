...
def restore_protection_status_model(text: str) -> str:
    protection_status_class = r'''
class ProtectionStatus {
  ...
  factory ProtectionStatus.fromMap(dynamic raw) {
    ...
    return ProtectionStatus(
      ...
      dnsCandidatePacketsObserved: _readInt(
        map,
      ...
      liveObservationSafetyGate: _readString(
        map,
...
'''
    ...
    if "class ProtectionStatus" not in text:
        text = text.replace(
            "import 'package:flutter/services.dart';\n",
            "import 'package:flutter/services.dart';\n\n" + protection_status_class,
        )
...
patch_file("lib/platform/protection_channel.dart", restore_protection_status_model)
write("android/app/src/main/kotlin/com/example/focus_shield_android/FocusShieldAccessibilityService.kt", r'''
package com.example.focus_shield_android
...
print("Phase 6B stronger accessibility auto-open patch completed successfully.")
