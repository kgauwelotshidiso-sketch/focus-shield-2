    ...
    return ListView(
      ...
      children: [
        ...
        ShieldCard(
          ...
          child: const Text(
            'Phase 6N fixed Home commitment truth. Home now reads commitment days directly from the same app state used by Settings, instead of reading stale 365-day SharedPreferences data.',
          ),
        ),
