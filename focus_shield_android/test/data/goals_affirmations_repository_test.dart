...
void main() {
  test(
    'in-memory repository saves and deletes goals and affirmations',
    () async {
      ...
      final customGoal = goals.firstWhere(
        (goal) => goal.title == 'Custom discipline goal',
      );
      ...
      expect(
        goals.any((goal) => goal.title == 'Custom discipline goal'),
        false,
      );
      expect(
        affirmations.any(
